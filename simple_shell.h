...
/* toem_history.c */
char *get_history_file(data_shell *info);
int write_history(data_shell *info);
int read_data_history(data_shell *info);
int build_history_list(data_shell *info, char *buf, int linecount);
int renumber_history(data_shell *info);
